...
public final class Messages {
    ...
    private enum Language {
        ENGLISH(Map.ofEntries(
                ...
                Map.entry("git.progress.github-cli-login", "Starting GitHub CLI browser login"),
                Map.entry("git.progress.github-cli-login-output", "GitHub CLI"),
                ...
                Map.entry("git.error.hint.github-cli-auth", "Detected a GitHub CLI login problem. In github-cli mode, NekoAutoPack starts gh auth login --web automatically; complete the browser authorization from the chat or console URL/code, then retry if the command timed out."),
        ...
        CHINESE(Map.ofEntries(
                ...
                Map.entry("git.progress.preparing-github-cli", "正在准备 GitHub CLI 认证"),
                Map.entry("git.progress.github-cli-login", "正在启动 GitHub CLI 浏览器登录"),
                Map.entry("git.progress.github-cli-login-output", "GitHub CLI"),
                ...
                Map.entry("git.error.hint.github-cli-auth", "检测到 GitHub CLI 登录问题。github-cli 模式会自动启动 gh auth login --web；请根据聊天或控制台里的 URL/验证码完成浏览器授权。如果命令超时，请完成授权后重试。"),
