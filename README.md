...
IAAuto is a Paper plugin for Minecraft 1.20.6 and newer. It adds `/iaauto push`, which copies `plugins/ItemsAdder/output/generated.zip` into a local git repository and pushes it to a configured GitHub remote.
